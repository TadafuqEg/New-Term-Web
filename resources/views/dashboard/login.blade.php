...
<head>
  ...
  <title>@yield('title', 'Term - Admin Login')</title>
  <!-- loader-->
  <link href="{{asset('dashboard/assets/css/pace.min.css')}}" rel="stylesheet"/>
  <script src="{{asset('dashboard/assets/js/pace.min.js')}}"></script>
  <!--favicon-->
  <link rel="icon" type="image/x-icon" href="{{asset('website/assets/imgs/logo2.svg')}}">
  <!-- Bootstrap core CSS-->
		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="{{asset('website/assets/imgs/logo2.svg')}}" alt="logo icon" style="width:80%; border-radius:5%;">
		 	</div>
